...
- Search for yesterday's meetings: call `mcp__9edf655b-9ecb-4911-aa24-26584c7014e0__search_meetings` with `from`/`to` set to yesterday's full-day range in ISO 8601 UTC (use `timezone` from `Context/agent-config.md` for offset)
